...
- Investigated the VPC resources systematically:
  ...
  - **Route Tables** — Public Route Table confirmed with `0.0.0.0/0 → IGW` route active
...
Both Internet Gateways show a state of Attached. The IGW for the Lab VPC (igw-0fad42e55b8954024) is correctly attached — this is not the issue.
...
The Public Route Table has two active routes: 10.0.0.0/16 to local for internal traffic, and 0.0.0.0/0 to igw-0fad42e55b8954024 for internet traffic. Both are Active — the routing is correct and not the issue.
